...
\textbf{In Press}
\begin{enumerate}[label= {[\arabic*]}]
\item Gewirtz ADH, {\bf Townes FW}, and Engelhardt BE. Telescoping bimodal latent Dirichlet allocation to identify expression QTLs across tissues {\it Life Science Alliance} (2021).\newline Preprint: \doi{10.1101/2021.10.27.466156}.
\end{enumerate}
