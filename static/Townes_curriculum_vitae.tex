...
\textbf{Preprints}
\begin{enumerate}[label= {[\arabic*]}]
\item Jones A, {\bf Townes FW}, Li D, Engelhardt BE. Contrastive latent variable modeling with application to case-control sequencing experiments. {\it arXiv} (2021). \arxiv{2102.06731}.
\end{enumerate}
