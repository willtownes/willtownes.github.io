...
%\vskip -.15in
\section{Service}
\textbf{Peer reviewer (journals)}: {\it American Journal of Human Genetics, Bioinformatics, Biostatistics, Epidemics, Genome Biology, IEEE Transactions on Computational Biology and Bioinformatics, Journal of Machine Learning Research, Journal of the Royal Statistical Society: Series C (Applied Statistics), NAR Genomics and Bioinformatics, Nature Biotechnology, Nature Communications, Nature Methods, Rapid Reviews/ Infectious Diseases}
\vskip .15in
...
\item Masters admissions committee (2025)
