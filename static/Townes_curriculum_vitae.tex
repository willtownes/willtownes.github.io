...
\item Maya Shen, ``Integrative Network Approaches in Multi-Omics and Genomics to Understand Diseases and Disorders''. CMU Statistics (2025-)
\item Quang Nguyen, ``Statistical modeling problems for player movement in sports with tracking data''. CMU Statistics (2025-)
\item Thea Sukianto, ``Addressing statistical and computational challenges in ocean heat content modeling with Argo floats''. CMU Statistics (2025-)
...
%\vskip -.15in
\section{Service}
\textbf{Peer reviewer (journals)}: {\it American Journal of Human Genetics, Bioinformatics, Biostatistics, Epidemics, Genome Biology, IEEE Transactions on Computational Biology and Bioinformatics, Journal of Machine Learning Research, Journal of the Royal Statistical Society: Series C (Applied Statistics), NAR Genomics and Bioinformatics, Nature Biotechnology, Nature Communications, Nature Methods, PLOS Pathogens, Rapid Reviews/ Infectious Diseases} %Annals of Applied Statistics
\vskip .15in
