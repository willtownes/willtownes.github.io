...
\item {\bf Townes FW}, Hicks SC, Ayree MJ, Irizarry RA. Varying-Censoring Aware Matrix Factorization for Single Cell RNA-Sequencing. {\it bioRxiv} (2017). doi: \url{https://doi.org/10.1101/166736}.
\end{enumerate}

\textbf{In Review}
\begin{enumerate}[label= {[\arabic*]}]
\item Marsh DM, {\bf Townes FW}, Cotter K, Farroni K, McCreary K, Petry R, Tilghman J. Temperature Tolerance and Species Range in Mountaintop Salamanders and Their Widespread Competitors. {\it Journal of Herpetology} (2018).
\end{enumerate}

\textbf{Peer-reviewed Journal Articles}
\begin{enumerate}[label= {[\arabic*]}]
\item Hicks SC, {\bf Townes FW}, Teng M, Irizarry RA. Missing Data and Technical Variability in Single-Cell RNA-Sequencing Experiments. {\it Biostatistics} (2017). doi: \url{http://dx.doi.org/10.1101/025528}.
