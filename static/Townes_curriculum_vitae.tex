...
\item {\bf Townes FW}. Mixed Poisson families with real-valued mixing distributions (2024).\\ \arxiv{2407.17614}.
\end{enumerate}
...
\textbf{Contributed}
\begin{enumerate}[label= {[\arabic*]}]
% \item Discrete central limit theorems. {\it Joint Statistical Meetings} (Boston, MA). August 2026.
...
\item Gabrielle Thivierge, ``Methods for performing and evaluating infectious disease forecasting and nowcasting''. CMU Statistics (2023-)
\end{enumerate}
