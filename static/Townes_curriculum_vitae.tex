...
\textbf{In Press}
\begin{enumerate}[label= {[\arabic*]}]
\item Thivierge G, Rumack A, {\bf Townes FW}. Does spatial information improve influenza forecasting? {\it Epidemics} (2025). Preprint: \arxiv{2408.12722}.
\end{enumerate}
...
\begin{enumerate}[label= {[\arabic*]}]
%\item Department of Mathematics, University of Miami. January 2025.
