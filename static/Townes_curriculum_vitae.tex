...
\textbf{Invited}
\begin{enumerate}[label= {[\arabic*]}]
%\item International Indian Statistical Association (Lincoln, NE)
...
%\vskip -.15in
\section{Service}
\textbf{Peer reviewer (journals)}: {\it American Journal of Human Genetics, Bioinformatics, Biostatistics, Epidemics, Genome Biology, Journal of Machine Learning Research, Journal of the Royal Statistical Society: Series C (Applied Statistics), NAR Genomics and Bioinformatics, Nature Biotechnology, Nature Communications, Nature Methods}
\vskip .15in
...
American Statistical Association, Institute of Mathematical Statistics,\\ International Biometric Society - Eastern North America Region,\\ International Society for Computational Biology%, Sigma Xi
%\newpage
