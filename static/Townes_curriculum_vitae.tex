...
\item Rosengart AL, Bidwell AL, Wolfe MK, Boehm AB, {\bf Townes FW}. Spatio-temporal variability of the Pepper Mild Mottle Virus biomarker in wastewater (2024). \arxiv{2408.12012}.
...
\begin{enumerate}[label={[\arabic*]}]
\item Ryan Zhang (CMU Statistics, 2024 Fall)
\item Marco Rayner (CMU Statistics, 2024 Spring)
\end{enumerate}
