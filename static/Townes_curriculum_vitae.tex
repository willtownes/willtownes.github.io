...
Princeton, NJ USA & \\  %twitter: @will_townes \\
\end{tabular}
...
\section{Summary}
I am a postdoctoral researcher working in biomedical data science with Dr. Barbara Engelhardt. I use probabilistic machine learning to gain insights into genomics, neuroscience, and ecology, with a particular focus on scalability and interpretability. I am also interested in spatial statistics, infectious disease, and economics. My goal is to produce statistical methods and open source software implementations to help scientists achieve their research goals more effectively.
...
& \textit{Doctoral Committee: Dr. Rafael Irizarry (Dana-Farber Cancer Institute, Data Science)} \\
& \hspace{1.25in} \textit{Dr. Jeff Miller (Harvard University, Biostatistics)} \\
& \hspace{1.25in} \textit{Dr. Martin Aryee (Massachusetts General Hospital, Pathology)} \\
...
\item Jones A, {\bf Townes FW}, Li D, Engelhardt BE. Alignment of spatial genomics and histology data using deep Gaussian processes (2022). \newline Preprint: \doi{10.1101/2022.01.10.475692}.
\item {\bf Townes FW}, Engelhardt BE. Nonnegative spatial factorization (2021). \newline Preprint: \arxiv{2110.06122}.
\item Gewirtz ADH, {\bf Townes FW}, and Engelhardt BE. Telescoping bimodal latent Dirichlet allocation to identify expression QTLs across tissues (2021). Preprint: \doi{10.1101/2021.10.27.466156}.
...
\textbf{Invited Talks}
\begin{enumerate}[label= {[\arabic*]}]
%\item Computational and Data Sciences Department, George Mason University. March 2022.
%\item Biomedical Data Science Department, Dartmouth College. February 2022.
%\item Statistics and Data Science, Carnegie Mellon University. March 2022.
...
\section{Peer Review}
\textbf{Journals}: {\it Bioinformatics, Biostatistics, Genome Biology, \newline ~~~NAR Genomics and Bioinformatics, Nature Communications}
