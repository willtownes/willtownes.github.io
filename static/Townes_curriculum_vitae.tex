...
\textbf{Seminars}
\begin{enumerate}[label= {[\arabic*]}]
\item Feature Selection and Dimension Reduction for Single Cell RNA-Seq. {\it Englehardt Lab, Computer Science Department, Princeton University}. February 2019.
