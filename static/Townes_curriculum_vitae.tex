...
\item Rumack A, Rosenfeld R, {\bf Townes FW}. Correcting for heterogeneity in real-time epidemiological indicators (2023).
...
\textbf{Invited}
\begin{enumerate}[label= {[\arabic*]}]
%\item NASEM wastewater panel. October 2023
...
\item The Delphi Center for Outbreak Analytics and Disease Modeling in Public Health Response: Innovation and Coordination (CDC). PI: Roni Rosenfeld. Responsibility: Key Faculty.
